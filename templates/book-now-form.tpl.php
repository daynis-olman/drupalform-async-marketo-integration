<div class="container-bn">
  <!-- form -->
  <div class="row">
    <div class="col-xs-1 col-sm-1 col-md-1 bn-form-step vfirst">
      <img src="/statics/img/drupal-form/book-now/1_active.png" id="bn-form-step-1">
    </div>
    <div class="col-xs-11 col-sm-11 col-md-11 bn-form-step-title">
      Select your service<br><br>
    </div>
  </div>

  <div class="row" id="bn-navigation">
    <div class="col-xs-1 col-sm-1 col-md-1 bn-step-vline" id="bn-step-vline1">
    </div>
    <div class="col-xs-11 col-sm-11 col-md-11 bn-nav-items">
      <div id="bn-nav1">
        <img src="/statics/img/drupal-form/book-now/book-now-nav1-1.svg">
      </div>
      <div id="bn-nav2">
        <img src="/statics/img/drupal-form/book-now/book-now-nav2.svg">
      </div>
    </div>
  </div> <!-- End Navigation -->
  ...
  <div class="row" id="bc-form-container"><!-- Book Consultant Form -->
    ...
    <!-- Centre Section -->
    <div class="row">
      <div class="col-xs-1 col-sm-1 col-md-1 bn-form-step">
    ...
    <div class="row bc-form-centre">
      <div class="col-xs-1 col-sm-1 col-md-1 bn-step-vline" id="bn-step-vline2">
      </div>
      <div class="col-xs-11 col-sm-11 col-md-11 bc-form-centre-items">
        <?php
    ...
    <div class="row bc-form-date-time">
      <div class="col-xs-1 col-sm-1 col-md-1 bn-step-vline" id="bn-step-vline3">
      </div>
      <div class="col-xs-11 col-sm-11 col-md-11 bc-form-date-time-items">
    ...
    <div class="row bc-form-personal-details">
      <div class="col-xs-1 col-sm-1 col-md-1" id="bn-step-vline4">
      </div>
      <div class="col-xs-11 col-sm-11 col-md-11 bc-form-personal-details-items">
  ...
  <div class="row" id="rc-form-container"><!-- Request Call Form -->
    ...
    <div class="row rc-form-personal-details">
      ...
      <div class="col-xs-11 col-sm-11 col-md-11 rc-form-personal-details-items">
